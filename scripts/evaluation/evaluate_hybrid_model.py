#!/usr/bin/env python3
"""
Evaluate the HYBRID trained M2M-100 model using SacreBLEU and RougeL
"""
...
# Configuration
CHECKPOINT_PATH = "m2m100_checkpoints_HYBRID/checkpoint_step4000_loss3.3074"
...
print("="*80)
print("HYBRID M2M-100 MODEL EVALUATION")
print("="*80)
print()
...
print(f"\nResults saved to hybrid_evaluation_results.json")
